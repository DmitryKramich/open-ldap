...
slappasswd -s andwegoagain2 > temp2

sudo cat > ldapuser.ldif <<'EOF'
dn: uid=tecmint,ou=People,dc=devopsldab,dc=com
objectClass: top
objectClass: account
...
ldapadd -x -w andwegoagain2 -D "cn=Manager,dc=devopsldab,dc=com" -f ldapuser.ldif
